...
class TerminalUiTests(unittest.TestCase):
    ...
    def test_desktop_includes_parallel_workspace_controls(self):
        ...
        self.assertNotIn("self.split_terminal_button =", desktop_source)
        self.assertIn("terminal_layout", desktop_source)
        self.assertIn('setObjectName("terminalToolbar")', desktop_source)
        self.assertIn("center_header.hide()", desktop_source)
        self.assertNotIn("center_layout.addWidget(center_header)", desktop_source)
